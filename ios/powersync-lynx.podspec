Pod::Spec.new do |s|
  ...
  s.pod_target_xcconfig = {
    ...
    'HEADER_SEARCH_PATHS' => '"$(PODS_TARGET_SRCROOT)/../shared" "$(PODS_TARGET_SRCROOT)/../shared/third_party/sqlite" "$(PODS_TARGET_SRCROOT)/../third_party/sqlite"',
    'GCC_PREPROCESSOR_DEFINITIONS' => 'PS_SQL_LINK_CORE=1 SQLITE_THREADSAFE=1 SQLITE_ENABLE_FTS5=1 SQLITE_USE_URI=1 SQLITE_DQS=0 SQLITE_DEFAULT_MEMSTATUS=0 SQLITE_OMIT_DEPRECATED=1 $(inherited)',
