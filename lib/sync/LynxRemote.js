...
function toArrayBuffer(input) {
  ...
  throw new TypeError('TextDecoder.decode expected ArrayBuffer or typed array');
}
...
function createLynxTextDecoder() {
  ...
  return {
    decode(input, options) {
      ...
      return globalThis.TextCodecHelper.decode(complete.buffer.slice(complete.byteOffset, complete.byteOffset + complete.byteLength));
    }
  };
}
